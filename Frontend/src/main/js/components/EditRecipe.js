...
import {updateRecipe} from 'app-actions/RecipeActions'

export const EditRecipe = ({changeFormInput, form, submitForm}) => {
  const onFormSubmit = () => {
    submitForm(form)
  }
...
export const EditRecipeContainer = connect(mapStateToProps, mapDispatchToProps)(EditRecipe)
